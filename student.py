...
class Student:
    def __init__(self,root):
     ...
     # first image
        ...
        # third image
        img2=Image.open("C:/face recognition attendence system/images/images.jpeg")
        ...
        semster_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",13,"bold"),state="read only",width=20)
        semster_combo["values"]=("select semster","semster-1","semster-2","semster-3","semster-4","semster-5","semster-6","semster-7","semster-8")
        ...
        # Roll No
        roll_n0_label=Label(class_student_frame,text="Roll No:",font=("times new roman",13,"bold"),bg="white")
        ...
        img_right=Image.open("C:/face recognition attendence system/images/student details.jpg")
        ...
        # =======serach system==============
        search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Searchb system",font=("times new roman",13,"bold"))
    ...
    def add_data(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Laxmi@1234",database="face_rec")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                cap=cv2.VideoCapture(0) #also give path of img
                img_id=0
                while True:
                ...
                messagebox.showinfo("Result","Generating data sets compilted!!!")
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
