...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open("C:/face recognition attendence system/images/facialrecognition.png")
        ...
        img_bottom=Image.open("C:/face recognition attendence system/images/photos.jpg")
