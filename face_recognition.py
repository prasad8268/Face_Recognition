...
class face_recognition:
    def __init__(self,root):
        ...
        # 1st image
        img_top=Image.open("C:/face recognition attendence system/images/face.png")
        ...
        # 2nd image
        img_bottom=Image.open("C:/face recognition attendence system/images/Facial-Recognition.jpg")
    ...
    def mark_attendence(self,i,r,n,d):
        with open("kiran.csv","r+",newline="\n") as f:
            ...
            if((i not in name_list) and (r not in name_list) and (i not in name_list) and (n not in name_list) and (d not in name_list)):
                now=datetime.now()
    ...
    def face_recog(self):
        ...
        clf=cv2.face.LBPHFaceRecognition_create()
